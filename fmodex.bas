...
Public Const FMOD_VERSION As Long = &H40101
...
Public Declare Function FMOD_System_SetProxy Lib "fmodex.dll" (ByVal System As Long, ByVal Proxy As String) As FMOD_RESULT
Public Declare Function FMOD_System_GetProxy Lib "fmodex.dll" (ByVal System As Long, ByRef Proxy As Byte, ByVal Proxylen As Long) As FMOD_RESULT
