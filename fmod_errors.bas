...
Public Function FMOD_ErrorString(errcode As FMOD_RESULT) As String
    Select Case errcode
        ...
        Case Is = FMOD_ERR_DSP_CONNECTION:         FMOD_ErrorString = "DSP connection error.  Either the connection caused a cyclic dependancy or a generator unit attempted to have a unit attached to it."
        Case Is = FMOD_ERR_DSP_FORMAT:             FMOD_ErrorString = "DSP Format error.  A DSP unit may have attempted to connect to this network with the wrong format.  IE a floating point unit on a PocketPC system."
        ...
        Case Is = FMOD_ERR_FILE_COULDNOTSEEK:      FMOD_ErrorString = "Couldn't perform seek operation."
        ...
        Case Is = FMOD_ERR_INITIALIZED:            FMOD_ErrorString = "Cannot call this command after Systeminit."
        ...
        Case Is = FMOD_ERR_NEEDSOFTWARE:           FMOD_ErrorString = "Tried to use a feature that requires the software engine but the software engine has been turned off."
        ...
        Case Is = FMOD_ERR_PLUGIN:                 FMOD_ErrorString = "An unspecified error has been FMOD_ErrorString =ed from a 3rd party plugin."
        Case Is = FMOD_ERR_PLUGIN_MISSING:         FMOD_ErrorString = "A requested output, dsp unit type or codec was not available."
        Case Is = FMOD_ERR_PLUGIN_RESOURCE:        FMOD_ErrorString = "A resource that the plugin requires cannot be found."
        ...
        Case Is = FMOD_ERR_TOOMANYCHANNELS:        FMOD_ErrorString = "The sound created exceeds the allowable input channel count.  This can be increased with System::setMaxInputChannels"
        ...
        Case Is = FMOD_ERR_UNSUPPORTED:            FMOD_ErrorString = "A commmand issued was not supported by this object.  Possibly a plugin without certain callbacks specified."
