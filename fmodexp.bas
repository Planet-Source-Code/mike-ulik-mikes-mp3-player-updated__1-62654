...
' ============================================================================================ '
' FMOD Ex - Visual Basic Module.    Copyright (c), Firelight Technologies Pty, Ltd. 2004-2005.
'                                                                                              '
'                                                                                              '
' ============================================================================================ '
...
Public Const FMOD_VERSION As Long = &H40100
...
Public Enum FMOD_RESULT
    ...
    FMOD_ERR_DSP_CONNECTION         ' DSP connection error.  Either the connection caused a cyclic dependancy or a generator unit attempted to have a unit attached to it.
...
'[
    ...
    '<li>FMOD_OUTPUTTYPE_WAVWRITER - extradriverdata can be is a pointer to a char * filename that the wav writer will output to.
    '<li>FMOD_OUTPUTTYPE_DSOUND - extradriverdata can be is a pointer to a HWND so that FMOD can set the focus on the audio for a particular window.
...
'[
    ...
    'Multichannel sounds map 1:1. <br>
...
Public Enum FMOD_INITFLAGS
    ...
    FMOD_INIT_NONREALTIME = &H1                      ' All platforms - Output is driven with System::update.
    ...
    FMOD_INIT_DSOUND_DEFERRED = &H100                ' Win32 only - for DirectSound output - 3D commands are batched together and executed at System::update.
...
Public Enum FMOD_MODE
    ...
    FMOD_OPENUSER = &H400                    ' Opens a user created static sample or stream.
    ...
    FMOD_OPENONLY = &H2000                   ' Just open the file, dont prebuffer or read.  Good for fast opens for info, or when sound::readData is to be used.
    ...
    FMOD_3D_HEADRELATIVE = &H40000           ' Make the sound's position, velocity and orientation relative to the listener's position, velocity and orientation.
    FMOD_3D_WORLDRELATIVE = &H80000          ' Make the sound's position, velocity and orientation absolute. (default)
...
Public Const FMOD_CREATESOUNDEXINFO_SIZE As Long = 72 'sizeof(FMOD_CREATESOUNDEXINFO)
...
Public Declare Function FMOD_System_SetProxy Lib "fmodexp.dll" (ByVal System As Long, ByVal Proxy As String) As FMOD_RESULT
Public Declare Function FMOD_System_GetProxy Lib "fmodexp.dll" (ByVal System As Long, ByRef Proxy As Byte, ByVal Proxylen As Long) As FMOD_RESULT
